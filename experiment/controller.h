...
{
     enum STATE_SET_VIBRO {
         STATE_SET_TARGET_VIBRO_MIN_VALUE,
         STATE_SET_TARGET_VIBRO_MIN,
         STATE_SET_TARGET_VIBRO_VALUE,
         STATE_SET_TARGET_VIBRO,
         STATE_ACTIVATE_PID_VIBRO_VALUE,
         STATE_ACTIVATE_PID_VIBRO
     } stateSetVibro = STATE_SET_TARGET_VIBRO_MIN_VALUE;
     enum STATE_SET {
         STATE_SET_TARGET_VALUE,
         STATE_SET_TARGET,
         STATE_ACTIVATE_PID_VALUE,
         STATE_ACTIVATE_PID
...
public:
    ...
    RETCODE setTarget(QJsonObject &jOperation, float value);
    RETCODE setTargetVibro(QJsonObject &jOperation, float valueMin, float valueMax);
